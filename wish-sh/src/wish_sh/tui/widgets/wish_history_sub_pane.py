"""Wish History Sub Pane widget for wish-sh TUI."""
...
class WishHistorySubPane(BasePane):
    ...
    def __init__(self, *args, **kwargs):
        """Initialize the WishHistorySubPane.
    ...
    def update_for_wish_history_mode(self):
        ...
        self.update_content("sub-pane-content", self.MSG_WISH_HISTORY_MODE)
    
    def clear_command_output(self):
        """Clear the command output."""
        self.current_command = None
        self.update_content("sub-pane-content", self.MSG_NO_COMMAND_SELECTED)
