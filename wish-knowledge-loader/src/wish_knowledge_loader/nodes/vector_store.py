...
class VectorStore:
    ...
    def __init__(self, settings: Settings, logger: logging.Logger = None):
        ...
        self.logger.debug(f"OpenAI embeddings initialized")
    ...
    def store(self, title: str, documents: list[Document]) -> None:
        ...
        self.logger.info(f"Creating Chroma vector store...")
        ...
        self.logger.info(f"Starting vector embedding process (this may take a while)...")
